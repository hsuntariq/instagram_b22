...
<div class="post-underlay min-vh-100 w-100 z-3 position-fixed top-0">
    <div
        ...
        <h6 class="share-btn m-0 cursor-pointer position-absolute d-none text-primary" style="right:10px">Share</h6>
        ...
        <div class="d-flex" style="height:85%">
            ...
            <div style="width:100%" class="d-flex post-section flex-column justify-content-center align-items-center">
                <img width="100%" height="100%"
                    ...
                    class="preview-image object-cover d-none" alt="">
            ...
            <div class="caption-section  hide-textarea">
                ...
                <textarea name="" class="form-control my-3 border-0" rows="10" placeholder="Caption..."
